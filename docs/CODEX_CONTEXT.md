...
- Em 2026-08-30, regra de nome de evento/sala: o nome sempre inclui a data curta da propria ocorrencia (`dd/mm`). Se o nome for vazio, usa apenas `dd/mm`; em recorrencia, cada sala recebe sua respectiva data no nome. Cache atual: `checkin-cache-v156`, `app.js?v=20260830h`.
