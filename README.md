...
## Operacao SADMIN: testes de check-in

Para evitar que testes contaminem relatorios reais:
...
Para habilitar em um ambiente Supabase, aplique:

```sql
supabase/patch_sadmin_test_rooms_clear_checkins.sql
```
